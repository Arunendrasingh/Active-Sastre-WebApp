...
urlpatterns = [
    ...
    path('incresequantity/<int:cid>',
         views.incresequantity, name='incresequantity'),
    path('decresequantity/<int:cid>',
         views.decresequantity, name='decresequantity'),
    ...
    path('view_size/<int:s_id>&&<str:s_ge>',
         views.size.view_size, name="view_size"),
    path('update_size<int:s_id>/<str:s_ge>',
         views.size.update_size, name="update_size"),
    path('saveaddress', views.address.SaveAddress, name="saveaddress"),
    path('change_address/<int:id>',
         views.address.change_address, name="change_address"),
    path('delete_address/<int:id>',
         views.address.delete_address, name="delete_address"),
    path('addsize', views.size.addsize, name="addsize"),
    path('rate_product/<int:p_id>/<int:or_id>',
         views.rate_product, name="rate_product"),
    path('delete_size/<int:id>/<str:g_id>',
         views.size.delete_size, name="delete_size"),
    path('change_profile/<int:id>',
         views.user_profile.change_profile, name="changr_profile"),
